...
namespace Teczter.Data.Migrations
{
    ...
    [Migration("20250502074016_ErrorLogRequestLogRelationship")]
    partial class ErrorLogRequestLogRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Teczter.Data.MiddlewareModels.ErrorLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RequestLogId")
                        .IsUnique()
                        .HasFilter("[RequestLogId] IS NOT NULL");

                    b.ToTable("ErrorLogs");
                });

            modelBuilder.Entity("Teczter.Data.MiddlewareModels.RequestLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Teczter.Data.MiddlewareModels.ErrorLog", b =>
                {
                    b.HasOne("Teczter.Data.MiddlewareModels.RequestLog", "RequestLog")
                        .WithOne()
                        .HasForeignKey("Teczter.Data.MiddlewareModels.ErrorLog", "RequestLogId");
